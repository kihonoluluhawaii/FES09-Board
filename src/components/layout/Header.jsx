...
function Header(){
  ...
  return (
    <header className='min-w-80 bg-gray-400 dark:bg-gray-800 text-gray-800 dark:text-gray-500 transition duration-200 ease-in-out'>
        ...
        <div className='w-1/2 order-1 flex justify-end items-center md:order-2 md:w-auto'>
          { user ? (
            <p className='flex items-center'>
              ...
              { user.name }님 
              <Button size="sm" type="button" onClick={ handleLogout }>로그아웃</Button>
            </p>
          ) : (
